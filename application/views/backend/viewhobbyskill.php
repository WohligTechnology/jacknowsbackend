...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.skills + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/edithobbyskill?id=');?>"+resultrow.id+"&hobbyid="+resultrow.hobbyid+"&userid="+resultrow.userid+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=\"return confirm('Are you sure you want to delete?');\" href='<?php echo site_url('site/deletehobbyskill?id='); ?>"+resultrow.id+"&hobbyid="+resultrow.hobbyid+"&userid="+resultrow.userid+"'><i class='icon-trash '></i></a></td></tr>";
}
