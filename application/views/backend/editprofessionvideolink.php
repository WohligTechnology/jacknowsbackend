...
<h3 class="panel-title">professionvideolink Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editprofessionvideolinksubmit");?>' enctype= 'multipart/form-data'>
...
<a href='<?php echo site_url("site/viewprofessionvideolink?id=").$this->input->get('professionid')."&userid=".$this->input->get('userid'); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
