...
<h3 class="panel-title">profession Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editprofessionsubmit");?>' enctype= 'multipart/form-data'>
...
<a href='<?php echo site_url("site/viewprofession?id=").$this->input->get('userid'); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
