...
<h3 class="panel-title">professionphoto Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editprofessionphotosubmit");?>' enctype= 'multipart/form-data'>
