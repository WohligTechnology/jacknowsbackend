<div id="page-title">
<a href="<?php echo site_url("site/viewhobbyeducation"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
<h1 class="page-header text-overflow">hobbyeducation Details </h1>
</div>
<div id="page-content">
<div class="row">
<div class="col-lg-12">
...
Create hobbyeducation </h3>
</div>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createhobbyeducationsubmit");?>' enctype= 'multipart/form-data'>
<div class="panel-body">
...
<a href="<?php echo site_url("site/viewhobbyeducation?id=").$this->input->get('id')."&userid=".$this->input->get('userid'); ?>" class="btn btn-secondary">Cancel</a>
</div>
</div>
</form>
</div>
