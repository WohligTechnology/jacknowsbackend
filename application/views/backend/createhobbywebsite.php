<div id="page-title">
<a href="<?php echo site_url("site/viewhobbywebsite"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
...
Create hobbywebsite </h3>
</div>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createhobbywebsitesubmit");?>' enctype= 'multipart/form-data'>
<div class="panel-body">
