<div id="page-title">
<a class="btn btn-primary btn-labeled fa fa-plus margined pull-right" href="<?php echo site_url("site/createhobbyeducation?id=").$this->input->get('id')."&userid=".$this->input->get('userid'); ?>">Create</a>
...
<?php $this->chintantable->createsearch("hobbyeducation List");?>
