<div id="page-title">
    <a href="<?php echo site_url("site/viewquestionuser?id=".$question); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
                    ...
                    <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createquestionusersubmit");?>' enctype='multipart/form-data'>
                        <div class="panel-body">
                            <div class="form-group"  style="display:none;">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="normal-field" class="form-control" name="question" value='<?php echo set_value(' question ',$question);?>'>
                                </div>
                            </div>
