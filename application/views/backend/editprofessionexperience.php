...
<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					...
					<?php if($before->companylogo == "")
						 { }
						 else
						 { ?>
							<img src="<?php echo base_url('uploads')."/".$before->companylogo; ?>" width="140px" height="140px">
						<?php }
					?>
				  </div>
				</div>
...
<a href='<?php echo site_url("site/viewprofessionexperience?id=").$this->input->get('professionid')."&userid=".$this->input->get('userid'); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
