...
<h3 class="panel-title">hobbyskill Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edithobbyskillsubmit");?>' enctype= 'multipart/form-data'>
...
<a href='<?php echo site_url("site/viewhobbyskill?id=").$this->input->get('hobbyid')."&userid=".$this->input->get('userid'); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
