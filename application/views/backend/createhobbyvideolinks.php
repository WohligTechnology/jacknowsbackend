<div id="page-title">
<a href="<?php echo site_url("site/viewhobbyvideolinks"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
...
Create hobbyvideolinks </h3>
</div>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createhobbyvideolinkssubmit");?>' enctype= 'multipart/form-data'>
<div class="panel-body">
...
<a href="<?php echo site_url("site/viewhobbyvideolinks?id=").$this->input->get('id')."&userid=".$this->input->get('userid'); ?>" class="btn btn-secondary">Cancel</a>
</div>
</div>
</form>
</div>
